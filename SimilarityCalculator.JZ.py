...
class PairwisePearsonCorrelationCalculator(SimilarityCalculator):
    ...
    def UpdateSimilarity(self, corrMatrix, theOldMatrix, theMetagene, vectorReplacedWithGene, vectorRemoved):
        """
            0. ADJUST ALL COL INDEXES in CorrMatrix before doing anything else. Anything beyond VectorRemove needs to be adjusted by -1
        ...
        """
        #TODO: 0. ADJUST ALL COL INDEXES in CorrMatrix before doing anything else. Anything beyond VectorRemove needs to be adjusted by -1
    ...
    def ExtractTopCorrValues(self, thematrix, thingsToExtract, dim, globalHash, blockI, blockJ):
        ...
        """
        this list, extract non-overlapping pairs based on the highest possible corr values for them 
